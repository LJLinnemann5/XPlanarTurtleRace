declare namespace TcHmi.Controls.Beckhoff.TcHmiMotion {
    class TcHmiMotionControl extends TcHmi.Controls.System.TcHmiControl {
        ...
        /** Refernce to the axis information element */
        ...
        protected __ComboboxAxis: TcHmi.Controls.Beckhoff.TcHmiCombobox;
        ...
        protected __ComboboxStartMode: TcHmi.Controls.Beckhoff.TcHmiCombobox;
         ...
         */
        protected __onMouseDownPlusPlus: () => void;
        /**
         * a function to be called when the button + is pressed
         */
        protected __onMouseDownPlus: () => void;
        /**
         * a function to be called when the button -- is pressed
         */
        protected __onMouseDownMinusMinus: () => void;
        /**
         * a function to be called when the button - is pressed
         */
        protected __onMouseDownMinus: () => void;
        /**
